...
class StanfordDogsDataset(Dataset):
    ...
    def __init__(self, transform=None, mode="train", limit_files=None,
        ...
        assert sum(split_values) == 1.0, "Wrong split proportions given"
    ...
    def _find_classes(directory):
        ...
        """
        classes = [d.name for d in os.scandir(os.path.join(directory, "Images"))
                   if d.is_dir()]
        classes.sort()
    ...
    def make_dataset(self, directory, class_to_idx, mode):
        ...
        for target_class in sorted(class_to_idx.keys()):
            ...
            target_dir = os.path.join(directory, "Images", target_class)
